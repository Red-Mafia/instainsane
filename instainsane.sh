#!/bin/bash
# Coded by: Red-Mafia
# www.github.com/Red-Mafia
# whatsapp : wa.me/+923188214452
...
printf "\n"
printf "\e[1;77m\e[41m  Instagram Brute Forcer v1.0, Author: @RED-MAFIA  \e[0m\n" #aku syng dia. tapi dia syng orang lain
printf "\n"
}
